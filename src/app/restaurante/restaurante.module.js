...
var listar_pipes_1 = require("./listar/listar.pipes");
var restaurante_cadastrar_component_1 = require("./cadastrar/restaurante.cadastrar.component");
...
RestauranteModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [restaurante_component_1.RestauranteComponent, restaurante_cadastrar_component_1.RestauranteCadastrarComponent, listar_pipes_1.FiltroPorNome, restaurante_alterar_component_1.RestauranteAlterarComponent],
